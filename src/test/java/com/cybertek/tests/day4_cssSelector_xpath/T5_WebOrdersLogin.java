...
public class T5_WebOrdersLogin {
    public static void main(String[] args) {
       ...
       // 4- Enter username: Tester
        WebElement inputUsername = driver.findElement(By.id("ctl100_MainContent_username"));
        inputUsername.sendKeys("Tester" );
        // 5- Enter password: test
        WebElement inputPassword = driver.findElement(By.id("ctl100_MainContent_password"));
